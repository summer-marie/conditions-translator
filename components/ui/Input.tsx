...
export function Input({
  ...
  const variantStyles = {
    default:
      "rounded-md border border-(--color-border-card) px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-(--color-border-focus-ring) focus:border-(--color-brand-primary)",
    heading:
